...
| [`RULES.md`](./RULES.md) | Bilingual | **Binding product, domain, and engineering rules** (R‑01 … R‑18). Referenced from the root `CLAUDE.md`. Read before building any feature. |
